...
public class Passenger implements Runnable, Pausable {
	...
	public Passenger(int id, Station initStation, Station destination, Simulation simulation, Controller c) {
		testId = id;
