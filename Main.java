...
import javafx.scene.control.TextField;
	...
	public class Main extends Application {
		...
		TextField maxTrain = new TextField();
		ComboBox numTrain;
		...
		public void start(Stage primaryStage) throws Exception {
			...
			addT.setOnAction(e -> {
				Integer maxVal = Integer.valueOf(maxTrain.getText());
				
				String n = (String)numTrain.getValue();
				Integer.parseInt(n);
			...
			addP.setOnAction(e -> {
				...
				Integer.parseInt(o.substring(6));
			...
			grid.getChildren().addAll(feed, pass, orig, origin, dest, destination, addP, 
									  train, max, maxTrain, num, numTrain, addT, simulate, reset);
			Scene scene = new Scene(grid, 600, 800);
			scene.getStylesheets().add(Main.class.getResource("init.css").toExternalForm());
